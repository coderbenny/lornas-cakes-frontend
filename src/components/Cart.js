        ...
        <div className="bg-orange-500 h-[700px] flex-column items-center align-center p-5">
            ...
            <div className="cakeItem mx-auto bg-white w-[700px] p-3 h-[400px] overflow-y-auto flex flex-col">
                ...
                {shoppingCart.map((item) => {
                    return (
                        <div key={item.key} className="flex text-gray-100 p-2 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 border-4 hover:border-blue-500 rounded-md mb-3 shadow-lg items-center">
